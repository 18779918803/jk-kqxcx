...
Page({
  ...
  onLoad: function (options) {
    this.setData({
      ...
      organId: app.globalData.userInfo.organId,
      organ: app.globalData.userInfo.organ,
        ...
        success(res) {
          ...
          if (res.statusCode == 200) {
            if (res.data.code == 200) {
              page.data.userInfo.organId = page.data.organId;
              page.data.userInfo.organ = page.data.organ;
